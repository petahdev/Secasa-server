...
function sendEmailToAll($recipients, $name, $position, $message) {
    ...
    try {
        ...
        $mail->Body    = "
        <h2>Message from SECASA Admin (St. Paul)</h2>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($recipients)) {
        ...
        echo "<div style='color: red; text-align:center;'>No emails found for St. Paul members.</div>";
    }
}
